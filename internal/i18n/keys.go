...
const (
	...
	StatusPickerErrors       Key = "status.pickerErrors"
	StatusPickerWarnings     Key = "status.pickerWarnings"
	StatusPickerInfo         Key = "status.pickerInfo"
	StatusPickerHints        Key = "status.pickerHints"
