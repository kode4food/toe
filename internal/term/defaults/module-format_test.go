...
func (s *stubController) RestartLanguageServers(_ *view.Document, _ []string) ([]string, error) {
	return nil, nil
}
func (s *stubController) StopLanguageServers(_ *view.Document, _ []string) ([]string, error) {
	return nil, nil
}
func (s *stubController) ExecuteWorkspaceCommand(_ *view.Document, _ string, _ []string) error {
	return nil
}
...
func (s *stubController) ApplyCompletion(_ *view.Document, _ view.Id, _ view.CompletionItem) error {
	return nil
}
func (s *stubController) Hover(_ *view.Document, _ view.Id) (string, error) { return "", nil }
func (s *stubController) SignatureHelp(_ *view.Document, _ view.Id) (view.SignatureHelp, error) {
	return view.SignatureHelp{}, nil
}
func (s *stubController) TriggerSignatureHelp(_ *view.Document, _ view.Id) (view.SignatureHelp, error) {
	return view.SignatureHelp{}, nil
}
func (s *stubController) GotoDeclaration(_ *view.Document, _ view.Id) ([]view.Location, error) {
	return nil, nil
}
func (s *stubController) GotoDefinition(_ *view.Document, _ view.Id) ([]view.Location, error) {
	return nil, nil
}
func (s *stubController) GotoTypeDefinition(_ *view.Document, _ view.Id) ([]view.Location, error) {
	return nil, nil
}
func (s *stubController) GotoImplementation(_ *view.Document, _ view.Id) ([]view.Location, error) {
	return nil, nil
}
func (s *stubController) GotoReference(_ *view.Document, _ view.Id) ([]view.Location, error) {
	return nil, nil
}
func (s *stubController) RenameSymbolPrefill(_ *view.Document, _ view.Id) (string, error) {
	return "", nil
}
func (s *stubController) RenameSymbol(_ *view.Document, _ view.Id, _ string) error { return nil }
func (s *stubController) CodeActions(_ *view.Document, _ view.Id) ([]view.CodeAction, error) {
	return nil, nil
}
func (s *stubController) ApplyCodeAction(_ *view.Document, _ view.Id, _ view.CodeAction) error {
	return nil
}
func (s *stubController) DocumentHighlights(_ *view.Document, _ view.Id) ([]view.DocumentHighlight, error) {
	return nil, nil
}
func (s *stubController) DocumentLinks(_ *view.Document) ([]view.DocumentLink, error) {
	return nil, nil
}
func (s *stubController) ResolveDocumentLink(_ *view.Document, link view.DocumentLink) (view.DocumentLink, error) {
	return link, nil
}
func (s *stubController) DocumentSymbols(_ *view.Document) ([]view.Symbol, error) { return nil, nil }
func (s *stubController) WorkspaceSymbols(_ *view.Document, _ string) ([]view.Symbol, error) {
	return nil, nil
}
