...
// NormalMode enters normal mode from insert or select mode. On exit from append
// mode (restoreCursor==true) it moves the cursor back by one grapheme
// Trailing whitespace on blank lines (added by auto-indent) is stripped
...
// tryRestoreIndent removes auto-indent whitespace on a blank line when
// leaving insert mode
